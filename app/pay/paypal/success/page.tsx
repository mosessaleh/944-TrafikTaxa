    ...
    return (
      <div className="max-w-2xl mx-auto p-6">
        <div className="text-center">
          ...
          <p>Confirming your PayPal payment...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-2xl mx-auto p-6">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold mb-4">PayPal Payment Verification Failed</h1>
          <p className="text-gray-600 mb-6">
            We couldn't verify your PayPal payment. Please contact support if you were charged.
          </p>
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold mb-4">PayPal Payment Successful!</h1>
        <p className="text-gray-600 mb-6">
          Your payment of <strong>{amount} DKK</strong> has been processed successfully via PayPal.
        </p>
