  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <div className="bg-white rounded-2xl shadow-lg p-8">
        <h1 className="text-2xl font-bold text-center mb-6">Pay with Revolut</h1>
        ...
        <div className="bg-green-50 rounded-xl p-6 mb-6">
          <div className="text-center">
            ...
            <div className="text-green-600">Taxi Booking Payment</div>
          </div>
        </div>

        <div className="space-y-4">
          <div className="text-sm text-gray-600 text-center">
            <strong>Revolut Payment:</strong> Fast and secure payment through Revolut.
          </div>
        ...
        <div className="mt-8 space-y-4">
          <button
            ...
            disabled={loading}
            className="w-full bg-green-600 text-white py-4 px-6 rounded-xl font-semibold hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? "Processing..." : `Pay ${amount} DKK with Revolut`}
          </button>
