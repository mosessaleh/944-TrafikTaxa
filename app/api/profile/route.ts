...
export async function GET(){
  ...
  const safe = await prisma.user.findUnique({ where:{ id: me.id }, select:{ id:true, email:true, emailVerified:true, firstName:true, lastName:true, phone:true, address:true, role:true, canPayByInvoice:true, language:true } });
